...
#SBATCH --job-name=trainMotionAGFormer3dhp81Frames    # Job name
...
python3 train_3dhp.py \
    --config configs/mpi/MotionAGFormer-small_81.yaml \
    --new-checkpoint checkpoint_mpi_81 \
    --use-wandb \
    --wandb-name "MotionAGFormer_MPI_3DHP_81_frames_training"