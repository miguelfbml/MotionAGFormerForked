...
#SBATCH --job-name=trainMotionAGFormer3dhp5Frames    # Job name
...
python3 train_3dhp.py \
    --config configs/mpi/MotionAGFormer-small_5.yaml \
    --new-checkpoint checkpoint_mpi_5 \
    --use-wandb \
    --wandb-name "MotionAGFormer_MPI_3DHP_5_frames_training"